...
import { messageIcon, envelopeIcon, personIcon,behanceLogo, linkedInLogo, githubLogo, paperplaneIcon } from '../../assets';
      ...
      <div className={`flex flex-col w-[70%] `}>
        ...
        <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-4">
                ...
                <div className='flex items-baseline'>
                  <img className="w-[25px] mr-2" src={personIcon} alt="Person icon" />
                  <p>Name</p>
                </div>
              </label>
							<input class="w-full border border-input-border rounded-xl bg-input px-4 py-4 bg-mainPurple"/>
						</div>
            <div>
							<label class="font-bitter text-white block text-lg font-bold mb-1">
                <div className='flex items-end'>
                  <img className="w-[34px] mr-2 items-start" src={envelopeIcon} alt="envelope icon" />
                  <p>E-mail</p>
                </div>
              </label>
							<input type="email" class="w-full border border-input-border bg-input px-4 py-4 rounded-xl bg-mainPurple"/>
						</div>
						<div>
							<label class="font-bitter text-white block text-lg font-bold mb-1 ">
                  <div className='flex items-end'>
                    <img className="w-[30px] mr-2" src={messageIcon} alt="message icon" />
                    <p>Message</p>
                  </div>
              </label>
							<textarea type="email" class="w-full border border-input-border bg-input px-4 pt-4 h-56 resize-none bg-mainPurple rounded-xl"></textarea>
						</div>
						<button class="w-[140px] h-[60px] border-[#B730D9] border-2 rounded-md p-[2px] cursor-pointer text-white font-bold">
            <div className='flex justify-center items-end'>
              <img className="w-[20px] mr-2" src={paperplaneIcon} alt="paper plane icon" />
            ...
            <div className='flex items-end'>
              ...
              <a href="mailto:email@mydomain.com" class="font-opensans font-regular text-lg text-sky-500 underline mt-3 block">
