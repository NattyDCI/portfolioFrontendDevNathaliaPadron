...
const ProjectCard = ({ img, title, para, url, repo, codepen }) => {
  return (
    <div className='relative z-1 w-2xl w-[30rem] min-h-[30rem] min-w-[20rem] mx-auto shadow-custom bg-gray-900 rounded-lg cursor-pointer transition ease-in duration-400 overflow-hidden mb-8 m-5'>
      ...
      <div className='absolute dark:bg-primary bg-slate-200 w-full min-h-[17rem] h-[15rem] p-6 leading-relaxed bottom-0 left-0 bg-gray-800 cursor-grab text-center'>
